...
public class DriverInformation {
   ...
   //-------constructors----------
    ...
    public DriverInformation(ListOfInformation PersonalInformation, String name, String age, String number, String email, String adrees) {
        ...
        */
        String[] Delivery = {DriverID, name, age, number, email, DefaultStatus, adrees ,Rating( PersonalInformation,DriverID)};
        PersonalInformation.addLast(PersonalInformation, Delivery);
        serialID++;
