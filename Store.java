...
//------------------------------ATTREBUTS---------------------------------------
    ...
    private int rating_reviews = 100;
     ...
     private int StarincrementStore;
    private int MacincrementStore;
    private int PandincrementStore;
    private int NahdincrementStore;
    private int NeamincrementStore;
        ...
        switch (indexOfStoreArray) {
            ...
            case 1:
                ...
                product2 = new Item[]{
                    ...
                    new Item("Green Tea Latte(B)                      ", 20.0),
                    new Item("Brown Eggs Medium أ—30                   ", 21.25),
...
//        System.out.println();
    ...
    public int getStarincrementStore() {
        return StarincrementStore;
    }

    public void setStarincrementStore(int StarincrementStore) {
        this.StarincrementStore = StarincrementStore;
    }

    public int getMacincrementStore() {
        return MacincrementStore;
    }

    public void setMacincrementStore(int MacincrementStore) {
        this.MacincrementStore = MacincrementStore;
    }

    public int getPandincrementStore() {
        return PandincrementStore;
    }

    public void setPandincrementStore(int PandincrementStore) {
        this.PandincrementStore = PandincrementStore;
    }

    public int getNahdincrementStore() {
        return NahdincrementStore;
    }

    public void setNahdincrementStore(int NahdincrementStore) {
        this.NahdincrementStore = NahdincrementStore;
    }

    public int getNeamincrementStore() {
        return NeamincrementStore;
    }

    public void setNeamincrementStore(int NeamincrementStore) {
        this.NeamincrementStore = NeamincrementStore;
    }
